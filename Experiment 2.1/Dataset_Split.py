...
def simple_split(data_dir, output_dir, train_size=0.7, val_size=0.2, test_size=0.1):
    ...
    # Validating that ratios sum to 1.0
    assert abs(train_size + val_size + test_size - 1.0) < 0.001, "Ratio must sum to 1.0"
...
simple_split("Dataset", "Dataset Split", train_size=0.7, val_size=0.2, test_size=0.1)