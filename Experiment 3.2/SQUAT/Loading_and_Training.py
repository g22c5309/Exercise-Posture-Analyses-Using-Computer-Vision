...
class_to_idx = {
                'SQUAT_correct': 0,
                'SQUAT_feet_too_wide': 1,
                'SQUAT_front_bent': 2,
                'SQUAT_knees_inward': 3,
                'SQUAT_not_low_enough': 4
                }

# loaders
train_dataset = PoseDataset('SQUAT Var/Train', class_to_idx)
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)

test_dataset = PoseDataset('SQUAT Var/Test', class_to_idx)
